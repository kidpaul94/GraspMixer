...
For each object, we use a [Gazebo simulation](https://github.com/kidpaul94/grasp-factory) to simulate grasps generated by CSPE and record a success rate (*label*) of each sample. If you have your own simulation or a physical robot, you can use them as well. 
